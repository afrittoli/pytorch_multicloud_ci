...
\date[25 Feb 2026]{25 Feb 2026 | \textbf{X} ~@blackchip76 | \faGithub ~afrittoli}
...
\begin{speakerframe}[af_wind.jpg]{Andrea Frittoli}%
  {%
  \faGithub ~afrittoli | \faLinkedin ~andreafrittoli | \textbf{X} ~@blackchip76
  }%
  {%
  \begin{itemize}
...
\begin{blackframe}
  ...
  \begin{itemize}
    ...
    \item \textbf{X} ~@blackchip76 | \faGithub ~afrittoli
  \end{itemize}
\end{blackframe}
\note[itemize]{
