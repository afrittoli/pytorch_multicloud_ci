...
\begin{lgrayrwhiteframe}
  ...
  \begin{columns}[c]
    ...
    \centering
    \includegraphics[width=\textwidth,height=0.7\paperheight,keepaspectratio]{img/requirements-per-role.png}
  \end{columns}
...
\begin{grayframe}
  ...
  \begin{columns}[T]
    \column{0.50\textwidth}
    \centering
    \includegraphics[width=\textwidth,keepaspectratio]{img/diagrams-SLOs.png}
...
\begin{grayframe}
  ...
  \begin{columns}[T]
    \column{0.50\textwidth}
    \centering
    \includegraphics[width=\textwidth,keepaspectratio]{img/diagrams-Process.png}
...
\begin{grayframe}
  ...
  \begin{columns}[T]
    ...
    \column{0.50\textwidth}
    \centering
    \includegraphics[width=\textwidth,keepaspectratio]{img/hub.png}
    \vspace{0.3em}
    
    \includegraphics[width=\textwidth,keepaspectratio]{img/hub-api.png}
  \end{columns}
\end{grayframe}
\note[itemize]{
...
\begin{grayframe}
  ...
  \centering
  \includegraphics[width=0.95\textwidth,keepaspectratio]{img/pytorch-multi-cloud-infra-Overview.png}
\end{grayframe}
...
\begin{grayframe}
  ...
  \begin{columns}[T]
    ...
    \column{0.50\textwidth}
    \centering
    \includegraphics[width=\textwidth,keepaspectratio]{img/pytorch-multi-cloud-infra-Overview.png}
  \end{columns}
\end{grayframe}
\note[itemize]{
...
\begin{grayframe}
  ...
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item Vendor requests a JIT config from GHARTS using the JWT
