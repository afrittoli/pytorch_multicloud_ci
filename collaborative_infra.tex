...
\end{4squaresext}
\note[itemize]{
  \item Four working groups shown in overlapping squares
  \item Multi-Cloud CI and CI Infra on the left
  \item Accelerator Integration and Security on the right
}
