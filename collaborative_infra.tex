...
\begin{tealframe}
  \frametitle{The Vendor Community}
  
  \begin{tikzpicture}[remember picture, overlay]
    % Left side - Operating Systems (evenly distributed vertically)
    \node at (2.5, 2.2) {\includegraphics[height=1.1cm]{img/linux-logo.pdf}};
    \node at (2.5, 0.5) {\includegraphics[height=1.1cm]{img/apple-logo.pdf}};
    \node at (2.5, -1.2) {\includegraphics[height=1.1cm]{img/windows-logo.pdf}};
    
    % Right side - Hardware Vendors (evenly distributed)
    \node at (6.5, 2.2) {\includegraphics[height=1cm]{img/intel-logo.pdf}};
    \node at (6.5, 0.5) {\includegraphics[height=1cm]{img/nvidia-eye-logo.pdf}};
    \node at (6.5, -1.2) {\includegraphics[height=1cm]{img/amd-logo.pdf}};
    
    \node at (10, 2.2) {\includegraphics[height=1cm]{img/arm-logo.pdf}};
    
    % Others box - bottom right
    \node[draw, rounded corners, fill=custom3!40, minimum width=2.2cm, minimum height=0.9cm, align=center] at (10, -1.2) {\textbf{Others}};
  \end{tikzpicture}
\end{tealframe}
\note[itemize]{
  \item Show breadth of vendor ecosystem
  \item Each has different hardware/software stack
  \item Public CI = proof of support + quality signal
  \item Marketing value for vendors
  \item Quality assurance for users
  \item But who pays for all this testing?
}

\begin{grayframe}
  \frametitle{CI Infrastructure Today: By the Numbers}
  \textbf{Scale of Operations:}
  \begin{itemize}
    \item X,XXX CI jobs per day
    \item XX different platform configurations
    \item \$X.XM annual infrastructure costs
    \item XX hours of compute per day
    \item Growing XX\% year over year
  \end{itemize}
\end{grayframe}
\note[itemize]{
  \item Use real numbers to show scale
  \item Emphasize growth trajectory
  \item Cost is significant and growing
  \item This is just for CI, not including other infrastructure
  \item Unsustainable without new model
}
...
\begin{grayframe}
  ...
  \begin{itemize}
    \item \textbf{Engineering:} Maintaining integrations for all platforms
    \item \textbf{Financial:} Infrastructure costs growing faster than funding
  \end{itemize}
  ~\\
  \textbf{Security Challenges:}
  \begin{itemize}
    \item Vendor-contributed infrastructure must be secure
    \item Cannot compromise project or user security
  \end{itemize}
  ~\\
...
\begin{grayframe}
  ...
  \begin{itemize}
    ...
    \item Hosts multiple related projects
    \item Provides governance framework
    \item Enables vendor collaboration
  \end{itemize}
\end{grayframe}
\note[itemize]{
  ...
  \item Foundation model enables vendor participation
}

\begin{grayframe}
  \frametitle{Working Groups Addressing the Challenges}
  \textbf{Three Key Working Groups:}
  \begin{itemize}
    \item \textbf{Multi-Cloud CI WG:} Infrastructure sustainability \& scale
    \item \textbf{Accelerator Integration WG:} Platform integration \& engineering
    \item \textbf{Security WG:} Security standards \& practices
  \end{itemize}
  ~\\
  \textbf{Collaborative Approach:} Vendors + maintainers working together
\end{grayframe}
\note[itemize]{
  \item Three WGs created to tackle the challenges
  \item Multi-Cloud CI: focus of this talk
  \item Accelerator Integration: technical integration work
  \item Security: ensuring vendor contributions are secure
  \item All three work together
